...
if ( $nv_Request->isset_request( 'submit', 'post' ) )
{
	...
	$count = $db->query( 'SELECT COUNT(*) FROM ' . $db_config['prefix'] . '_' . $module_data . '_ward WHERE wardid=' . $db->quote( $row['wardid'] ) )->fetchColumn();
...
if( $show_view )
{
	...
	{
		$view['number'] = $number++;
		$view['count'] = $db->query( 'SELECT COUNT(*) FROM ' . $db_config['prefix'] . '_' . $module_data . '_ward WHERE wardid=' . $db->quote( $view['wardid'] ) )->fetchColumn();
