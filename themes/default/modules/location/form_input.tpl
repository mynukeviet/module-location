...
<div class="row">
	...
	<!-- BEGIN: district -->
	<div class="col-xs-24 col-sm-12 col-md-12 m-bottom">
		<select class="form-control" <!-- BEGIN: none_multiple -->name="districtid"<!-- END: none_multiple --> id="districtid" <!-- BEGIN: multiple -->name="districtid[]"<!-- END: multiple --> >
			<!-- BEGIN: blank_title -->
	...
	<!-- BEGIN: ward -->
	<div class="col-xs-24 col-sm-12 col-md-12 m-bottom">
		<select class="form-control" <!-- BEGIN: none_multiple -->name="wardid"<!-- END: none_multiple --> id="wardid" <!-- BEGIN: multiple -->name="wardid[]"<!-- END: multiple --> >
			<!-- BEGIN: blank_title -->
